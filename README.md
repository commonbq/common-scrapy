...
| [`homedepot_search`](#homedepot_search-keyword-apollo-bootstrap) | Active | bootstrap + html | anti-bot error page (provider unknown) | Home Depot keyword search via Apollo state. | 24 (ok) | - | `{"item_id":"336787835","sku":"1014334650","brand":"Lukyamzn","title":"14 in. Dual-Core Celeron N4000 Laptop 6 GB RAM 128 GB SSD IPS Displ...` |
...
| [`walmart_listing`](#walmart_listing-category) | Active | api + html | challenge page (provider unknown) | Walmart category listing spider (direct API+HTML flow). | 45 (ok) | electronics, home, clothing, beauty, toys, sports-and-outdoors, grocery | `{"item_id":"375041225","title":"Restaurado Apple iPhone 12 Restaurado - Desbloqueado para Cualquier Operador - 64GB Negro (Reacondicionad...` |
| [`walmart_search`](#walmart_search-keyword) | Active | api + html | challenge page (provider unknown) | Walmart keyword search spider. | 12 (ok) | - | `{"item_id":"13542163431","title":"ASUS Vivobook Go 15.6” Laptop, Intel i3-N305, 8GB, 256GB, Windows 11 Home in S mode, Cool Silver, E1504...` |
...
| Spider Name | Status | Method | Antibot | Description | Number of items output | Spider Categories | Sample output |
|---|---|---|---|---|---|---|---|
| [`anthropologie_listing`](#anthropologie_listing) | Experimental | api + html | reCAPTCHA / challenge-platform (observed) | Anthropologie listing spider (API + HTML fallback). | 0 (ok) | women, dresses, sale | `n/a` |
...
| [`homedepot_listing`](#homedepot_listing-category-apollo-bootstrap) | Flaky | bootstrap + html | anti-bot error page (provider unknown) | Home Depot category listing via Apollo state. | 0 (ok) | screwdrivers, drills, paint, light-bulbs, lumber | `n/a` |
| [`kohls_listing`](#kohls_listing) | Experimental | api | — | Kohl’s listing via `/web/catalog/...` API. | 0 (ok) | women, men, sale | `n/a` |
| [`nordstrom_listing`](#nordstrom_listing) | Experimental | bootstrap + html | anti-bot interstitial/wrapper (provider unknown) | Nordstrom listing parser; often blocked/changed. | 0 (timeout2) | women, men, kids, beauty, home, designer, sale | `{}` |
| [`nordstromrack_listing`](#nordstromrack_listing) | Experimental | playwright + html | challenge/blocking possible (provider unknown) | Nordstrom Rack listing spider via rendered category pages. | 0 (skipped2) | dresses, women, men, shoes | `{}` |
...
| Spider Name | Status | Method | Antibot | Description |
|---|---|---|---|---|
...
| [`walmart_search`](#walmart_search-keyword) | Active | api + html | challenge page (provider unknown) | Walmart keyword search spider. |
| [`walmart_listing`](#walmart_listing-category) | Active | api + html | challenge page (provider unknown) | Walmart category listing spider with anti-bot fallback. |
...
| [`homedepot_search`](#homedepot_search-keyword-apollo-bootstrap) | Active | bootstrap + html | anti-bot error page (provider unknown) | Home Depot keyword search via Apollo state. |
| [`homedepot_listing`](#homedepot_listing-category-apollo-bootstrap) | Flaky | bootstrap + html | anti-bot error page (provider unknown) | Home Depot category listing via Apollo state. |
...
| [`nordstrom_listing`](#nordstrom_listing) | Experimental | bootstrap + html | anti-bot interstitial/wrapper (provider unknown) | Nordstrom listing parser; often blocked/changed. |
| [`bestbuy_search`](#bestbuy_search--bestbuy_listing) | Flaky | bootstrap + html | challenge/error variant (provider unknown) | Best Buy search via Playwright + Apollo cache extract. |
| [`bestbuy_listing`](#bestbuy_search--bestbuy_listing) | Flaky | bootstrap + html | challenge/error variant (provider unknown) | Best Buy listing via Playwright + Apollo cache extract. |
